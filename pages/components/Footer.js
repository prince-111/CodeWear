...
import logo from "../../images/codechic logo 2.png"
...
const Footer = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    ...
    /> */}
      ...
      <p className="text-sm text-gray-500 px-4">Premium coding tshirt, hoodies and apparals</p>
  ...
  <div className="bg-gray-100">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 Preshoping.com — All Rights Reserved
      </p>
